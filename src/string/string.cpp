...
bool starts_with(StringConstRef input_string, char c, bool ignore_case)
{
  bool result = false;
...
bool starts_with(StringConstRef input_string, StringConstRef starter, bool ignore_case)
{
  bool result = false;
...
bool ends_with(StringConstRef input_string, char c, bool ignore_case)
{
  bool result = false;
  if (input_string.size() > 0)
  {
