...
TEST_CASE("The evaluator can interpret tuple indexing", "[evaluator]")
{
  setlocale(LC_ALL, "");
  EnvironmentPtr environment = std::make_shared<Environment>();
  String filename = "";
  String buffer = "x := (1, 2, 3, 4, 5); y := x[0];";
...
TEST_CASE("The evaluator can interpret tuple indexing in while loops", "[evaluator]")
{
  setlocale(LC_ALL, "");
  EnvironmentPtr environment = std::make_shared<Environment>();
  String filename = "";
...
TEST_CASE("The evaluator can interpret tuple indexing in nested lists", "[evaluator]")
{
  setlocale(LC_ALL, "");
  EnvironmentPtr environment = std::make_shared<Environment>();
  String filename = "";
